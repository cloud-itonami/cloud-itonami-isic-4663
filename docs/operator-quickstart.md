# Operator Quickstart — Wholesale of construction materials, hardware, plumbing and heating equipment

Shortest path from clone to a verified local dry-run for **ISIC 4663** (`cloud-itonami-isic-4663`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-4663.git
cd cloud-itonami-isic-4663
```
...
- Blueprint governor key: `potable-water-safety-governor`
- Likely source path: `buildmattrade.governor.cljc`
